...
def expand_key(key):
    ...
    while len(expanded_key) < b:
        ...
        output = t
        output = rot_word(output[0], output[1], output[2], output[3])
...
expand_key([random.randint(0, 255) for i in range(32)])
